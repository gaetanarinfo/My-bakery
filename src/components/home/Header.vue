      ...
      <div class="hn-container">
        ...
        <div class="nav-right">
          ...
          <div class="actions">
            ...
            <a v-if="geolocation" role="button"
              v-bind:class="this.$route.path === '/' ? 'scroll-click' : 'scroll-click-s'" data-scroll="bakery-list">
